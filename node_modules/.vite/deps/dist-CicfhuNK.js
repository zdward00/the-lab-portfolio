...
function Portal({ portal: { root, container: { className: containerClassName, style: containerStyle, ...containerRest } = {} }, animation, styles, className, on, close, labels, children }) {
	...
	return mounted ? (0, import_react_dom.createPortal)(import_react.createElement(LightboxRoot, {
		...
		...containerRest
	}, children), root || document.body) : null;
}
...
//#endregion
export { cssClass as $, ACTIVE_SLIDE_COMPLETE as $t, NoScrollModule as A, PLUGIN_COUNTER as An, useForkRef as At, TimeoutsProvider as B, SLIDE_STATUS_LOADING as Bn, usePointerSwipe as Bt, LightboxStateProvider as C, MODULE_CONTROLLER as Cn, useAnimation as Ct, NavigationModule as D, MODULE_ROOT as Dn, useDocumentContext as Dt, NavigationButton as E, MODULE_PORTAL as En, useDelay as Et, RTLContextProvider as F, PLUGIN_SLIDESHOW as Fn, useLightboxState as Ft, cleanup as G, VK_ARROW_RIGHT as Gn, useThrottle as Gt, ToolbarModule as H, SLIDE_STATUS_PLAYING as Hn, useRTL as Ht, Root as I, PLUGIN_THUMBNAILS as In, useLoseFocus as It, computeSlideRect as J, withPlugins as Jt, clsx as K, VK_ESCAPE as Kn, useTimeouts as Kt, RootModule as L, PLUGIN_ZOOM as Ln, useMotionPreference as Lt, PortalModule as M, PLUGIN_FULLSCREEN as Mn, useLayoutEffect as Mt, PreviousIcon as N, PLUGIN_INLINE as Nn, useLightboxDispatch as Nt, NextIcon as O, MODULE_TOOLBAR as On, useEventCallback as Ot, RTLContext as P, PLUGIN_SHARE as Pn, useLightboxProps as Pt, createNode as Q, ACTION_SWIPE as Qt, SwipeState as R, SLIDE_STATUS_COMPLETE as Rn, useNavigationState as Rt, LightboxStateContext as S, MODULE_CAROUSEL as Sn, useA11yContext as St, Navigation as T, MODULE_NO_SCROLL as Tn, useController as Tt, addToolbarButton as U, UNKNOWN_ACTION_TYPE as Un, useRTLContext as Ut, Toolbar as V, SLIDE_STATUS_PLACEHOLDER as Vn, usePreventWheelDefaults as Vt, calculatePreload as W, VK_ARROW_LEFT as Wn, useSensors as Wt, createIconDisabled as X, ACTION_NEXT as Xt, createIcon as Y, ACTION_CLOSE as Yt, createModule as Z, ACTION_PREV as Zt, LightboxDefaultProps as _, EVENT_ON_POINTER_MOVE as _n, round as _t, CloseIcon as a, CLASS_NO_SCROLL as an, getSlideKey as at, LightboxPropsProvider as b, IMAGE_FIT_CONTAIN as bn, translateLabel as bt, ControllerModule as c, CLASS_SLIDE_WRAPPER as cn, isImageFitCover as ct, ErrorIcon as d, ELEMENT_ICON as dn, makeComposePrefix as dt, ACTIVE_SLIDE_ERROR as en, cssVar as et, EventsContext as f, EVENT_ON_KEY_DOWN as fn, makeInertWhen as ft, Lightbox as g, EVENT_ON_POINTER_LEAVE as gn, reflow as gt, ImageSlide as h, EVENT_ON_POINTER_DOWN as hn, parseLengthPercentage as ht, CarouselModule as i, CLASS_FULLSIZE as in, getSlideIndex as it, Portal as j, PLUGIN_DOWNLOAD as jn, useKeyboardNavigation as jt, NoScroll as k, PLUGIN_CAPTIONS as kn, useEvents as kt, DocumentContext as l, CLASS_SLIDE_WRAPPER_INTERACTIVE as ln, isImageSlide as lt, IconButton as m, EVENT_ON_POINTER_CANCEL as mn, parseInt as mt, A11yContextProvider as n, ACTIVE_SLIDE_PLAYING as nn, getSlide as nt, Controller as o, CLASS_NO_SCROLL_PADDING as on, hasSlides as ot, EventsProvider as p, EVENT_ON_KEY_UP as pn, makeUseContext as pt, composePrefix as q, activeSlideStatus as qn, useWheelSwipe as qt, Carousel as r, CLASS_FLEX_CENTER as rn, getSlideIfPresent as rt, ControllerContext as s, CLASS_SLIDE as sn, hasWindow as st, A11yContext as t, ACTIVE_SLIDE_LOADING as tn, devicePixelRatio as tt, DocumentContextProvider as u, ELEMENT_BUTTON as un, label as ut, LightboxDispatchContext as v, EVENT_ON_POINTER_UP as vn, setRef as vt, LoadingIcon as w, MODULE_NAVIGATION as wn, useContainerRect as wt, LightboxRoot as x, IMAGE_FIT_COVER as xn, translateSlideCounter as xt, LightboxPropsContext as y, EVENT_ON_WHEEL as yn, stopNavigationEventsPropagation as yt, TimeoutsContext as z, SLIDE_STATUS_ERROR as zn, usePointerEvents as zt };

//# sourceMappingURL=dist-CicfhuNK.js.map